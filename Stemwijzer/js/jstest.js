...
function loadparties() {
    ...
    while (wrappertrue.children.length > 1) {
        wrappertrue.children[1].remove();
    }
    while (wrapperfalse.children.length > 1) {
        wrapperfalse.children[1].remove();
    }
    ...
    subjects[quest]["parties"].forEach(function (value) {
        ...
        switch (value.position) {
            case "pro":
                wrappertrue.appendChild(partydetail);
                break;

            case "contra":
                wrapperfalse.appendChild(partydetail);
                break;
